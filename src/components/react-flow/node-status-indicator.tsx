...
export const BorderLoadingIndicator = ({
  ...
  return (
    <>
      <div className={cn("absolute -top-[2px]-left-[2px] h-[calc(100%+2px)] w-[calc(100%+2px)]",className)}>
        <style>
          {`
        @keyframes spin {
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute -top-[2px] -left-[2px] h-[calc(100%+3.5px)] w-[calc(100%+3.5px)] rounded-[5px] border-2",
          className,
        )}
      />
      {children}
