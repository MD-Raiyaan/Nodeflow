...
export function NodeSelector({
  ...
  const handleNodeSelect=useCallback((selection:NodeTypeOption)=>{
      ...
      setNodes((nodes)=>{
        const hashInitialTrigger=nodes.some(
        ...
        <div>
          {triggerNode.map((nodeType) => {
            ...
            return (
              <div
                key={nodeType.type}
                className="w-full justify-start h-auto py-5 px-4 rounded-none cursor-pointer border-l-2 border-r-transparent hover:border-l-primary"
